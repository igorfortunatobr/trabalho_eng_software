...
-- Copiando estrutura do banco de dados para bd_engsoftware
CREATE DATABASE IF NOT EXISTS `bd_engsoftware` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_engsoftware`;

-- Copiando estrutura para tabela bd_engsoftware.categoria
...
-- Copiando estrutura para tabela bd_engsoftware.categoriatransacao
...
-- Copiando estrutura para tabela bd_engsoftware.transacao
...
-- Copiando estrutura para tabela bd_engsoftware.usuario
