...
describe('TransacaoCRUD', () => {
    ...
    //     cy.get('button').contains('Nova Transação').click();
    //     cy.get('input#descricao').type('Transação Teste 2');
    //     cy.get('input#data').type(new Date().toISOString().split('T')[0]);
    //     cy.get('input#receita').check();
        
    //     // Adicionar categorias
    //     cy.get('select#novaCategoria').select('Categoria 1');
    //     cy.get('input#novaCategoria').type('200.00');
    //     cy.get('button').contains('Adicionar Categoria').click();
    //     cy.get('select#novaCategoria').select('Categoria 2');
    //     cy.get('input#novaCategoria').type('50.00');
    //     cy.get('button').contains('Adicionar Categoria').click();
    ...
    //     cy.get('.card-title').contains('Total Receitas').parent().find('.card-text').should('contain', 'R$ 250,00');
    //     cy.get('.card-title').contains('Saldo').parent().find('.card-text').should('contain', 'R$ 250,00');
    // });
